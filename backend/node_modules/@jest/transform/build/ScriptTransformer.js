>
								...
								<appv:Libraries>
									<appv:Library>
										...
										<appv:Win64>[{ProgramFilesCommonX64}]\Microsoft Shared\OFFICE16\MSO.DLL</appv:Win64>
									</appv:Library>
								</appv:Libraries>
							</appv:Version>
						</appv:Versions>
				...
				<appv:ApplicationId>DCF</appv:ApplicationId>
			</appv:COM>
		</appv:Extension>
		<appv:Extension Category="AppV.COM">
			<appv:COM>
				<appv:x64>
					<appv:Interfaces>
						<appv:Interface>
							<appv:InterfaceId>{00194002-D9C3-11D3-8D59-0050048384E3}</appv:InterfaceId>
							<appv:Description>ILicAgent</appv:Description>
		...
		<appv:Extension Category="AppV.COM">
			<appv:COM>
				<appv:x64>
					<appv:Interfaces>
						<appv:Interface>
							<appv:InterfaceId>{20C139DB-3671-481C-B905-8A6173317D72}</appv:InterfaceId>
							<appv:Description>_SensitivityLabelEvents</appv:Description>
							<appv:ProxyStubClassId>{00020420-0000-0000-C000-000000000046}</appv:ProxyStubClassId>
							<appv:TypeLibrary>
								<appv:TypeLibraryId>{2DF8D04C-5BFA-101B-BDE5-00AA0044DE52}</appv:TypeLibraryId>
								<appv:VersionNumber>2.8</appv:VersionNumber>
							</appv:TypeLibrary>
		...
		<appv:Extension Category="AppV.COM">
			<appv:COM>
				<appv:x64>
					<appv:Interfaces>
						<appv:Interface>
							<appv:InterfaceId>{4291224C-DEFE-485B-8E69-6CF8AA85CB76}</appv:InterfaceId>
							<appv:Description>IAssistance</appv:Description>
							<appv:ProxyStubClassId>{00020424-0000-0000-C000-000000000046}</appv:ProxyStubClassId>
							<appv:TypeLibrary>
								<appv:TypeLibraryId>{2DF8D04C-5BFA-101B-BDE5-00AA0044DE52}</appv:TypeLibraryId>
								<appv:VersionNumber>2.8</appv:VersionNumber>
				...
				<appv:TypeLibraries>
					<appv:TypeLibrary>
						<appv:TypeLibraryId>{2DF8D04C-5BFA-101B-BDE5-0need to keep this object in the local scope of this module.
